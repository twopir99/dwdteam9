...
public class RecommenderEvaluatorKNNBased {
		...
		try
		{
			...
			RecommenderBuilder rBuilder = new RecommenderBuilder(){
				...
				public Recommender buildRecommender(DataModel dataModel) throws TasteException{
					...
					KnnItemBasedRecommender recommender = new KnnItemBasedRecommender(dataModel, itemSimilarity, optimizer, noOfRecommendations);
			...
			for (RecommendedItem recommendedItem : recommendations){
				System.out.println("### KNN_BasedRecommender :: " + recommendedItem.getItemID() + " VALUE ::: " + recommendedItem.getValue());
			}
