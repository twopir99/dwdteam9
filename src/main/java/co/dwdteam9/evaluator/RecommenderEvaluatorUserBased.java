...
public class RecommenderEvaluatorUserBased {
	...
	public static void main(String[] args){
		...
		try
		{
			...
			UserBasedRecommender recommender = (UserBasedRecommender) rBuilder.buildRecommender(dataModel);
			...
			for (RecommendedItem recommendedItem : recommendations){
				System.out.println("### UserBasedRecommender :: " + recommendedItem.getItemID() + " VALUE ::: " + recommendedItem.getValue());
			}
